...
const estate = { id: 'e1', sourceId: 's1', deceasedName: 'SMITH, JANE', idNumberMasked: 'Unknown', dateOfDeath: '2026-01-01', gazetteDate: '2026-07-31', province: 'Gauteng', district: 'Johannesburg', masterOffice: 'Johannesburg', estateNumber: '1/2026', executorName: 'Executor', executorContact: 'Unknown', executorEmail: '', valueBand: 'Unknown', assetTypes: ['other'], rawNoticeSnippet: '', gazetteRef: '55077', status: 'pending', hasProperty: false } satisfies DeceasedEstate;
